        ...
        <ul id="menu-principal">
          ...
          <li id="mostrar">Menu
            <ul id="submenu">
			  ...
			  <li onmouseover="mudaFoto('hqs.png')" onmouseout="mudaFoto('coop.png')"><a href="hqs.php">HQs</a></li>
              <li onmouseover="mudaFoto('laptop.png')" onmouseout="mudaFoto('coop.png')"><a href="development.php">Development</a></li>
      ...
      <table id="tabela">
        ...
        <tbody id="games-list">
		  <?php 
				...
				$conecta = mysqli_connect("127.0.0.1", "root", "") or print (mysql_error()); 
