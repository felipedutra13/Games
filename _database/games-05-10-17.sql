...
--
-- Host: 127.0.0.1
-- Generation Time: 05-Out-2017 às 14:48
...
(1, 'grammar', 'swollen', 'inchado', 'n'),
(2, 'grammar', 'branches', 'galhos', 'y'),
(3, 'grammar', 'burglary', 'assalto', 'n'),
(4, 'grammar', 'puddle', 'poça', 'y'),
(5, 'grammar', 'storey', 'andar', 'n'),
(6, 'grammar', 'tide', 'maré', 'y'),
(7, 'grammar', 'loot', 'saquear', 'n'),
(8, 'grammar', 'jeopardy', 'perigo', 'y'),
(9, 'grammar', 'asleep', 'adormecido', 'y'),
(10, 'grammar', 'dismiss', 'dispensar', 'y'),
(11, 'grammar', 'spare', 'poupar', 'n'),
(12, 'grammar', 'hit somebody up', 'pedir favor', 'n'),
(13, 'grammar', 'blacksmith', 'ferreiro', 'n'),
(14, 'grammar', 'sign up', 'registrar', 'y'),
(15, 'grammar', 'sign in', 'entrar', 'y'),
(16, 'grammar', 'lense', 'lente', 'n'),
(17, 'grammar', 'embed', 'embutir', 'n'),
(18, 'grammar', 'to garden', 'jardinar', 'n'),
(19, 'grammar', 'fulfill', 'cumprir', 'n'),
(20, 'grammar', 'to book', 'agendar', 'n'),
(21, 'grammar', 'on leave', 'licensa', 'y'),
(22, 'grammar', 'lodge', 'alojamento', 'y'),
(23, 'grammar', 'whip', 'chicote', 'y'),
(24, 'exercise', '_ (prep) my way home. I generally meet a lot of adults who are going to work.', 'on', 'y'),
(25, 'exercise', '_ you _ (try) Chiles when you were in Mexico ?', 'did try', 'y'),
(26, 'exercise', '_ you ever _ (try) Mexican food ?', 'have tried', 'n'),
...
(29, 'exercise', 'Charles Dickens _ (write) Oliver Twist in 1837.', 'wrote', 'y'),
...
(32, 'exercise', 'He is known _ (preposition) an experienced teacher.', 'as', 'y'),
(33, 'exercise', 'He was leaning _ (preposition) a table.', 'against', 'y'),
(34, 'exercise', 'How many times _ Henry VIII _ (marry) ?', 'did marry', 'y'),
(35, 'exercise', 'How many times _ you _ (marry)?', 'have been married', 'y'),
(36, 'exercise', 'I _ (live) in the same house since i was born.', 'have been living', 'y'),
...
(39, 'exercise', 'I would rather live on a farm than to live in a city. (mistake)', 'I would rather live on a farm than live in a city.', 'y'),
(40, 'exercise', 'It''s no use asking them keep quiet. (mistake)', 'It''s no use asking them to keep quiet.', 'y'),
(41, 'exercise', 'My father doesn''t know speak English. (mistake)', 'My father doesn''t know how to speak English.', 'y'),
(42, 'exercise', 'She _ (write) her autobiography for the past 18 months.', 'has been writting', 'n'),
(43, 'exercise', 'The teacher was pleasing with the result of your examination. (mistake)', 'The teacher was pleased with the result of your examination.', 'y'),
(44, 'exercise', 'We can''t get everything we want from life, we must just make the best _ (preposition) it.', 'of', 'y'),
...
(47, 'exercise', 'You have never been _ (prep) love or you wouldn''t speak like that.', 'in', 'y'),
(48, 'exercise', 'You should cope _ (prep) difficulties in order to succeed in life.', 'with', 'y'),
(49, 'exercise', 'I promise I _ (not tell) anyone about your secret.', 'will not tell', 'y'),
(50, 'exercise', 'I _ (visit) Andreia in the prison next week.', 'am going to visit', 'y'),
(51, 'exercise', 'I think Temer _ (resign) in two weeks time.', 'will resign', 'y'),
(52, 'exercise', 'By the end of the year, Eduardo _ (spend) a year in prison.', 'will have spent', 'y'),
...
(55, 'exercise', 'We _ (leave) tomorrow at 7 a.m., so you''d better get a good night sleep.', 'are leaving', 'y'),
...
(58, 'exercise', 'This car belongs _ (prep) my brother.', 'to', 'y'),
(59, 'exercise', 'Vegetarians live _ (prep) vegetables, fruit and nuts.', 'on', 'y'),
(60, 'exercise', 'The teacher said we had to learn all these expressions _ (prep) heart.', 'by', 'n'),
(61, 'exercise', 'She is famous _ (prep) her intelligence.', 'for', 'y'),
(62, 'exercise', 'I''m tired _ (prep) boiled eggs.', 'of', 'y'),
(63, 'grammar', 'cope', 'lidar', 'y'),
(64, 'grammar', 'blast', 'explosao', 'y'),
(65, 'grammar', 'stray cat', 'gato de rua', 'n'),
(66, 'grammar', 'furry', 'peludo', 'y'),
(67, 'grammar', 'outnumber', 'superar em numero', 'y'),
(68, 'exercise', 'I stopped to play football 20 years ago. (mistake)', 'I stopped playing football 20 years ago.', 'y'),
(69, 'exercise', 'Thanks for letting me to borrow your car. (mistake)', 'Thanks for letting me borrow your car.', 'y'),
(70, 'exercise', 'How about to play tennis at the weekend? (mistake)', 'How about playing tennis at the weekend?', 'y'),
(71, 'exercise', 'I went to the station for get my train. (mistake)', 'I went to the station to get my train.', 'y'),
(72, 'exercise', 'It isn''t easy learn to play the piano. (mistake)', 'It isn''t easy to learn to play the piano.', 'y'),
(73, 'exercise', 'To walk can be very relaxing. (mistake)', 'Walking can be very relaxing.', 'y'),
(74, 'grammar', 'fee', 'taxa', 'y'),
(75, 'grammar', 'tax', 'imposto', 'y'),
(76, 'grammar', 'struggle', 'luta', 'y'),
(77, 'exercise', 'I _ (not go) to the cinema since last year.', 'haven''t gone', 'n'),
(78, 'exercise', 'Kate has a much more interesting job/work in the company now.', 'job', 'y'),
(79, 'grammar', 'rodent', 'roedor', 'y'),
(80, 'grammar', 'spoonful', 'colherada', 'y'),
(81, 'grammar', 'attorney', 'advogado', 'n'),
(82, 'grammar', 'wrath', 'ira', 'n'),
(83, 'grammar', 'preacher', 'pregador', 'n'),
(84, 'grammar', 'on sale', 'promocao', 'y'),
(85, 'grammar', 'car hood', 'capo do carro', 'y'),
(86, 'grammar', 'carjacking', 'roubo de carro', 'n'),
(87, 'grammar', 'tease', 'provocar', 'n'),
(88, 'exercise', 'The museum _ (open) at 10 am daily.', 'opens', 'y'),
(89, 'exercise', 'By this time next year, Debora _ (speak) English fluently.', 'will be speaking', 'y'),
(90, 'exercise', 'By the end of the year, Debora _ (work) at Fitec for a year.', 'will have worked', 'y'),
(91, 'exercise', 'We _ (meet) the new clients tonight.', 'are meeting', 'y'),
(92, 'exercise', 'The boys _ (start) school on Monday.', 'start', 'y'),
(93, 'exercise', 'I save 50 dollars a month and i started in January. So, by the end of the year I _ (save) $600 dollars.', 'will have saved', 'y'),
(94, 'exercise', 'I _ (do) some shopping after class. I need to get some food.', 'am doing', 'y'),
(95, 'exercise', 'Don''t call me tomorrow at 10 oclock because I _ (drive).', 'will be driving', 'y'),
(96, 'grammar', 'kneel', 'ajoelhar', 'y'),
(97, 'grammar', 'bail', 'fianca', 'y'),
(98, 'grammar', 'vacancy', 'vaga', 'y'),
(99, 'grammar', 'mattress', 'colchao', 'y'),
(100, 'grammar', 'leash', 'coleira', 'y'),
(101, 'grammar', 'to bark', 'latir', 'n'),
(102, 'grammar', 'shrink', 'encolher', 'y'),
(103, 'grammar', 'to wound', 'ferir', 'n'),
(104, 'grammar', 'stewardess', 'comissaria de bordo', 'y'),
(105, 'grammar', 'to swell', 'inchar', 'y'),
(106, 'grammar', 'to sew', 'costurar', 'n'),
(107, 'grammar', 'leftover', 'sobra', 'n');
...
('Resident Evil 2', 'Playstation', 'Survival Horror', 'Backlog', 'http://howlongtobeat.com/gameimages/250px-Resident_Evil_2.jpg'),
...
('Epic Mickey', 'Wii', 'Plattform', 'Playing', 'https://howlongtobeat.com/gameimages/Epic_Mickey.jpg'),
...
('Super Mario 3D Land', 'Nintendo 3DS', 'Adventure', 'Playing', 'https://howlongtobeat.com/gameimages/250px-Super-Mario-3D-Land-Logo.jpg'),
...
('Yoshi''s Island DS', 'Nintendo DS', 'Plattform', 'Backlog', 'https://howlongtobeat.com/gameimages/250px-YoshisIslandDScover.PNG'),
...
('inFAMOUS: Second Son', 'Playstation 4', 'Action', 'Backlog', 'https://howlongtobeat.com/gameimages/Infamous_second_son_boxart.jpg'),
...
('Slasher (Season 1)', '', 'Thriller', 'Watching', 'https://img.fstatic.com/jT09Ydgz1zlKKABspYBU6a0w8t8=/210x312/smart/https://cdn.fstatic.com/media/movies/covers/2016/02/slasher_tNone.png'),
